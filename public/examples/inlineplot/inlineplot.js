...
const wg = Wordgard.create({
  parent: document.querySelector("#inlineplot-editor") ,
  doc: `<p>This editor supports key names. You can create a new one by pressing <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>k</kbd>.</p>`,
  config: [
    basicSchema(),
    menuBar(),
    key()
